...
//
// Generated on: 2017-04-16 22:34:42
//
// -------------------------------------------------------------
...
////////////////////////////////////////////////////////////////
  ...
  assign  phase_8 = (cur_count == 4'b1000 && we == 1'b1)? 1 : 0;

  assign  phase_0 = (cur_count == 4'b0000 && we == 1'b1)? 1 : 0;
  ...
  assign product_1 = $signed({mul_temp, 2'b00});
  ...
  assign acc_sum_1 = ((add_temp[26] == 1'b0 & add_temp[25] != 1'b0) || (add_temp[26] == 1'b0 && add_temp[25:0] == 26'b01111111111111111111111111) // special case0
) ? 26'b01111111111111111111111111 : 
      (add_temp[26] == 1'b1 && add_temp[25] != 1'b1) ? 26'b10000000000000000000000000 : add_temp[25:0];
  ...
  assign output_typeconvert = ((acc_final[25] == 1'b0 & acc_final[24] != 1'b0) || (acc_final[25] == 1'b0 && acc_final[24:7] == 18'b011111111111111111) // special case0
) ? 18'b011111111111111111 : 
      (acc_final[25] == 1'b1 && acc_final[24] != 1'b1) ? 18'b100000000000000000 : ({acc_final[25], acc_final[24:0] + {acc_final[7], {6{~acc_final[7]}}}})>>>7;
